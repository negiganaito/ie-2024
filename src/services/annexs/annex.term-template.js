...
- Total amount of contract: {{totalAmount}} USD.`,

  3: `As a result of the discussions, all parties have agreed to the following details regarding the port of destination and shipment terms of the agreement:
- Port of Destination: {{portOfDestination}}
- Shipment Terms: {{shipmentTerm}}`,
}
